...
openapi-client-python:
	...
	@npx @openapitools/openapi-generator-cli generate -i openapi.yaml -g python-legacy -o dist/python-asyncio/ -c config-python-asyncio.yaml -t openapi-generator-templates/resources/python-legacy
